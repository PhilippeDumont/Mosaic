...
(function() {
  var Library, View, Weather, currentBigImage, currentMovie, currentPosition, display, fs, library, readBigImage, readMovie, readSmalImage, run, sizeOf, state, view;
  ...
  View = (function() {
    ...
    View.prototype.getHtml = function(element, x1, y1) {
      var html;
    ...
    View.prototype._getHtmlOfImage = function(element, x1, y1) {
      var html;
      this.element = element;
      this.x = x1;
      this.y = y1;
